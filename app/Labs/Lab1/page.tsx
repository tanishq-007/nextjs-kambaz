...
<div id="wd-images">
  ...
  <br />
  <img id="wd-teslabot" src="/images/teslabot1.jpg" height="200px" width="400px"/></div>
...
<div id="wd-forms">
  ...
  <form id="wd-text-fields">
    ...
    <input placeholder="Tanishq" id="wd-text-fields-username" /> <br />
...
/>
  ...
  <h5>Text boxes</h5>
<label>another  example</label><br/>
<textarea 
id="wd-textarea" 
cols={30} 
rows={10}
defaultValue={`There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable. 
